...
elseif strcmp(Simulation,'GaussianTwoCarRCLinearGradient')
    eval('SetGaussian2CarParasRCOnlyLinearGradient');
elseif strcmp(Simulation,'GaussianTwoCarRCExponentialGradient')
    eval('SetGaussian2CarParasRCOnlyExponentialGradient');
end
